...
public class AddPlace extends AppCompatActivity {
    ...
    int count=0;
    com.hashtagvoyages.hashtagvoyages.add_adapter adapter;
        ...
        listView.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        TextView temp = (TextView) view.findViewById(R.id.name12);
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(AddPlace.this, splitter_main.class));
        finish();
